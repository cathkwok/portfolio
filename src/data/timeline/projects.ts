...
export const projects: TimelineEntry[] = [
  {
    ...
    sideLabel: "2025 – now",
    blurb:
      "An internal AI documentation platform I took from a community side project to a resilient, enterprise-tier tool used by roughly 125K Monthly Active Users",
